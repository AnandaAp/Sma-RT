...
class AdminSession(activity: Activity) {
    ...
    companion object {
        ...
        const val SHARED_PREFERENCE_ADMIN_ID_KEY = "ADMIN ID CODE"
        ...
        const val SHARED_PREFERENCE_ALAMAT_KEY = "ALAMAT CODE"
        const val SHARED_PREFERENCE_KODE_POS_KEY = "POS CODE"
