...
class RecyclerViewJenisProduk(
    ...
    val listener: RecyclerViewTerlaris.OnAdapterListener
):
    ...
    class MyViewHolder(itemView: View): RecyclerView.ViewHolder(itemView) {
        var namaBarang: TextView = itemView.findViewById(R.id.detailnamaproduk)
        var hargaBarang: TextView = itemView.findViewById(R.id.tvHargaProduk)
        var gambarBarang: ImageView = itemView.findViewById(R.id.detailfotoproduk)
        var btnTambah: ImageView = itemView.findViewById(R.id.btnTambahKeranjang)
    }
