...
@Parcelize
data class GetAllPersuratanResponse(

	@field:SerializedName("get_all_persuratan")
	val getAllPersuratan: List<GetAllPersuratanItem?>? = null,
...
@Parcelize
data class GetAllPersuratanItem(
